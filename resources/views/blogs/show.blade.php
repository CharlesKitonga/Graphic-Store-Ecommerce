...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>Graphic Design Store</title>
    <!--
			CSS
			============================================= -->
  <link rel="stylesheet" href="{{asset('css/blog/linearicons.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/themify-icons.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/bootstrap.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/nice-select.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/nouislider.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/blog/ion.rangeSlider.css')}}" />
    <link rel="stylesheet" href="{{asset('css/blog/ion.rangeSlider.skinFlat.css')}}" />
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item active"><a class="nav-link" href="#">Blog Details</a></li>
								</ul>
							</li>
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{asset('images/backend_images/products/medium/'.$blogDetails->image)}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-3  col-md-3" style="margin-left: -00px;">
                            <div class="blog_info text-right">
                                <div class="post_tag">
                                    <a href="#">{{$blogDetails->heading}}</a>
                                </div>
                                <ul class="blog_meta list">
                                    <li><a href="#">{{$blogDetails->author}}<i class="lnr lnr-user"></i></a></li>
                                    <li><a href="#">{{$blogDetails->created_at->diffForHumans()}}<i class="lnr lnr-calendar-full"></i></a></li>
                                </ul>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <img style="" class="img-fluid" src="{{asset('images/backend_images/products/small/'.$image->image)}}" alt="">
                                </div>
                                @endforeach
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- End footer Area -->
        ...
        <script src="{{asset('js/blog/vendor/jquery-2.2.4.min.js')}}"></script>
   <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
    crossorigin="anonymous"></script>
   <script src="{{asset('js/blog/vendor/bootstrap.min.js')}}"></script>
   <script src="{{asset('js/blog/jquery.ajaxchimp.min.js')}}"></script>
   <script src="{{asset('js/blog/jquery.nice-select.min.js')}}"></script>
   <script src="{{asset('js/blog/jquery.sticky.js')}}"></script>
    <script src="{{asset('js/blog/nouislider.min.js')}}"></script>
   <script src="{{asset('js/blog/jquery.magnific-popup.min.js')}}"></script>
   <script src="{{asset('js/blog/owl.carousel.min.js')}}"></script>
   <!--gmaps Js-->
   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
   <script src="{{asset('js/blog/gmaps.min.js')}}"></script>
