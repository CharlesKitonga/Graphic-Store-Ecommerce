      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form  enctype="multipart/form-data" class="form-horizontal" method="post" action="{{url('/admin/edit_product/'.$productDetails->id)}}" name="edit_product" id="edit_product" novalidate="novalidate">
              {{ csrf_field()}}
               <div class="control-group">
                <label class="control-label">Under Category</label>
                <div class="controls">
                  <select name="category_id" id="category_id" value="
                  {{$productDetails->category_id}}" style="width: 220px;">  
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <img style="width::40px;" src="{{ asset('/images/backend_images/products/small'.$productDetails->image) }}"><a href="{{url('/admin/delete_product_image/'.$productDetails->id)}}">Delete</a>
                  @endif
                </div>
              </div>
